...
@dataclass
class Config:
    experiment_name: str = "G4_CNN_BiLSTM_LinEx_MCD_v2"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run G4 experiment")
...
def main():
    ...
    val_true_det, val_pred_det, _ = trainer.predict(val_loader)
    test_true_det, test_pred_det, _ = trainer.predict(test_loader)
